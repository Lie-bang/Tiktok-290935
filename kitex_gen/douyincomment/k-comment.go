...
func (p *CommentServiceCommentActionArgs) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *CommentServiceCommentActionArgs) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *CommentServiceCommentActionArgs) field2Length() int {
	l := 0
