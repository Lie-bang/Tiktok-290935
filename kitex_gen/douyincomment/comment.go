...
type CommentService interface {
	CommentAction(ctx context.Context, request *DouyinCommentActionRequest, uid int64) (r *DouyinCommentActionResponse, err error)
...
func (p *CommentServiceClient) CommentAction(ctx context.Context, request *DouyinCommentActionRequest, uid int64) (r *DouyinCommentActionResponse, err error) {
...
func (p *commentServiceProcessorCommentAction) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	if retval, err2 = p.handler.CommentAction(ctx, args.Request, args.Uid); err2 != nil {
...
func (p *CommentServiceCommentActionArgs) GetUid() (v int64) {
	return p.Uid
}
func (p *CommentServiceCommentActionArgs) SetRequest(val *DouyinCommentActionRequest) {
	p.Request = val
}
func (p *CommentServiceCommentActionArgs) SetUid(val int64) {
	p.Uid = val
}
...
func (p *CommentServiceCommentActionArgs) ReadField2(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return err
	} else {
		p.Uid = v
...
func (p *CommentServiceCommentActionArgs) Field2DeepEqual(src int64) bool {
