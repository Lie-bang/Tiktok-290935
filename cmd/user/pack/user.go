...
func User(u *db.User, relationInfo *douyinrelation.User, favoriteCount, workCount, totalFavorite int64) *douyinuser.User {
	if u == nil {
		return nil
	}
...
//
//func UserG(u *db.User, relationInfo *douyinrelation.User) *douyinuser.User {
//	if u == nil {
//		return nil
//	}
//
...
//	for idx, u := range us {
//		if temp := UserG(u, relationInfos[idx]); temp != nil {
